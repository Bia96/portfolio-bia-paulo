        ...
        <div className="content">
          ...
          <article>
            <section>
              ...
              <p>
                No IBM Research, trabalhei junto a outros designers e
                especialistas para desenvolver interfaces e fluxos para projetos
                de computação cognitiva. Meus maiores desafios foram projetar
                UIs que comunicavam processos complexos, como analisar o risco
                de um prospecto de exploração de petróleo, ou descobrir as
                características de uma região de cubo sísmico. Participei
                diretamente de projetos com diversos clientes. Um desses
                projetos foi o Subsurface Interpretation Advisor, desenvolvido
                em parceria com a empresa portuguesa Galp Energia.
              </p>

              <p>
                O SIA é um sistema baseado em AI para acelerar a interpretação
                sísmica na indústria de óleo e gás. Os principais usuários são
                geólogos e geofísicos, que analisam uma série de dados
                (anotações, artigos científicos, mapas estratigráficos, cubos
                sísmicos, cases anteriores) para decidir o futuro de prospectos
                para exploração de óleo e gás. O sistema ajuda os profissionais
                a agregar esses dados, e fornece sugestões e evidências. O
                conhecimento é agregado e construído ao longo do tempo a cada
                novo projeto.
              </p>
              ...
              <p>
                ...
                intenções, prioridades e necessidades que iriam guiar o design
                da interface. Comecei transformando essas direções em conceitos
